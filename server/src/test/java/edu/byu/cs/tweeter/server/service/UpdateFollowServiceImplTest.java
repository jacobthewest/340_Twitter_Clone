...
public class UpdateFollowServiceImplTest {
    ...
    private UpdateFollowDAO mockUpdateFollowDAO;
    private UpdateFollowServiceImpl updateFollowServiceImplSpy;
    ...
    public void setup() {
        ...
        mockUpdateFollowDAO = Mockito.mock(UpdateFollowDAO.class);
        Mockito.when(mockUpdateFollowDAO.updateFollow(validRequest)).thenReturn(correctResponse);

        updateFollowServiceImplSpy = Mockito.spy(UpdateFollowServiceImpl.class);
        Mockito.when(updateFollowServiceImplSpy.getUpdateFollowDAO()).thenReturn(mockUpdateFollowDAO);
    }

    @Test
    public void testGetUpdateFollow_validRequest_correctResponse() throws IOException, TweeterRemoteException {
        UpdateFollowResponse response = updateFollowServiceImplSpy.updateFollow(validRequest);
    ...
    public void testGetUpdateFollow_invalidRequest_correctResponse() throws IOException, TweeterRemoteException {
        Assertions.assertThrows(RuntimeException.class, () -> {
            updateFollowServiceImplSpy.updateFollow(invalidRequest);
        });
    }
